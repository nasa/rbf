...
!  REPRESENTED BY THE GOVERNMENT AGENCY LISTED BELOW ("GOVERNMENT AGENCY"). THE 
!  UNITED STATES GOVERNMENT, AS REPRESENTED BY GOVERNMENT AGENCY, IS AN INTENDED
!  THIRD-PARTY BENEFICIARY OF ALL SUBSEQUENT DISTRIBUTIONS OR REDISTRIBUTIONS OF
!  THE SUBJECT SOFTWARE. ANYONE WHO USES, REPRODUCES, DISTRIBUTES, MODIFIES OR 
!  REDISTRIBUTES THE SUBJECT SOFTWARE, AS DEFINED HEREIN, OR ANY PART THEREOF, 
!  IS, BY THAT ACTION, ACCEPTING IN FULL THE RESPONSIBILITIES AND OBLIGATIONS 
!  CONTAINED IN THIS AGREEMENT. 
!  
!  Government Agency: National Aeronautics and Space Administration 
!  Government Agency Original Software Designation: LAR-19607-1
!  Government Agency Original Software Title: Mode shape interpolation via 
!  radial basis functions
!  Government Agency Point of Contact for Original Software: s.j.massey@nasa.gov
!  
!  1. DEFINITIONS
!  
...
!     101. However, the act of including Subject Software as part of 
!     a Larger Work does not in and of itself constitute a 
!     Modification.
!  G. "Original Software" means the computer software first released 
!     under this Agreement by Government Agency with Government 
!     Agency designation LAR-19607-1 and entitled Mode shape 
!     interpolation via radial basis functions, including source 
...
!  also make the source code freely available, and must 
!  provide with each copy of the Subject Software information 
!  on how to obtain the source code in a reasonable manner on 
!  or through a medium customarily used for software exchange.
!  
!  B. Each Recipient must ensure that the following copyright notice 
!  appears prominently in the Subject Software:
!   
!  This software may be used, reproduced, and provided to others 
!  only as permitted under the terms of the agreement under which 
!  it was acquired from the U.S. Government. Neither title to, nor 
!  ownership of, the software is hereby transferred. This notice 
...
!  
!  The following license and copyright notices govern the noted 
!  3rd party software package KDTREE2 included in the NASA 
!  SOFTWARE:
!  
!  The KDTREE2 software is licensed under the terms of the 
!  Academic Free Software License, listed herein. In addition, 
!  users of this software must give appropriate citation in 
!  relevant technical documentation or journal paper to the 
!  author, Matthew B. Kennel, Institute For Nonlinear Science, 
!  preferably via a reference to the www.arxiv.org repository of 
!  this document, {\tt www.arxiv.org e-print: physics/0408067}. 
!  This requirement will be deemed to be advisory and not 
!  mandatory as is necessary to permit the free inclusion of the 
!  present software with any software licensed under the terms of 
!  any version of the GNU General Public License, or GNU Library 
!  General Public License.
!  
!  Academic Free License
!  Version 1.1
!  
!  This Academic Free License applies to any original work of 
!  authorship (the "Original Work") whose owner (the "Licensor") 
!  has placed the following notice immediately following the 
!  copyright notice for the Original Work: "Licensed under the 
!  Academic Free License version 1.1."
!  
!  Grant of License. Licensor hereby grants to any person 
!  obtaining a copy of the Original Work ("You") a world-wide, 
!  royalty-free, non-exclusive, perpetual, non-sublicenseable 
!  license (1) to use, copy, modify, merge, publish, perform, 
!  distribute and/or sell copies of the Original Work and 
!  derivative works thereof, and (2) under patent claims owned or 
!  controlled by the Licensor that are embodied in the Original 
!  Work as furnished by the Licensor, to make, use, sell and offer 
!  for sale the Original Work and derivative works thereof, 
!  subject to the following conditions.
!  
!  Right of Attribution. Redistributions of the Original Work must 
!  reproduce all copyright notices in the Original Work as 
!  furnished by the Licensor, both in the Original Work itself and 
!  in any documentation and/or other materials provided with the 
!  distribution of the Original Work in executable form.
!  
...
!  promote products derived from this Original Work without 
!  express prior written permission of the Licensor.
!  
!  WARRANTY AND DISCLAIMERS. LICENSOR WARRANTS THAT THE COPYRIGHT 
!  IN AND TO THE ORIGINAL WORK IS OWNED BY THE LICENSOR OR THAT 
!  THE ORIGINAL WORK IS DISTRIBUTED BY LICENSOR UNDER A VALID 
!  CURRENT LICENSE FROM THE COPYRIGHT OWNER. EXCEPT AS EXPRESSLY 
!  STATED IN THE IMMEDIATELY PRECEEDING SENTENCE, THE ORIGINAL 
!  WORK IS PROVIDED UNDER THIS LICENSE ON AN "AS IS" BASIS, 
!  WITHOUT WARRANTY, EITHER EXPRESS OR IMPLIED, INCLUDING, WITHOUT 
!  LIMITATION, THE WARRANTY OF NON-INFRINGEMENT AND WARRANTIES 
!  THAT THE ORIGINAL WORK IS MERCHANTABLE OR FIT FOR A PARTICULAR 
!  PURPOSE. THE ENTIRE RISK AS TO THE QUALITY OF THE ORIGINAL WORK 
!  IS WITH YOU. THIS DISCLAIMER OF WARRANTY CONSTITUTES AN 
!  ESSENTIAL PART OF THIS LICENSE. NO LICENSE TO ORIGINAL WORK IS 
...
!  EVEN IF SUCH PERSON SHALL HAVE BEEN INFORMED OF THE POSSIBILITY 
...
!  
!  License to Source Code. The term "Source Code" means the 
!  preferred form of the Original Work for making modifications to 
!  it and all available documentation describing how to access and 
...
!  
!  Mutual Termination for Patent Action. This License shall 
!  terminate automatically and You may no longer exercise any of 
!  the rights granted to You by this License if You file a lawsuit 
!  in any court alleging that any OSI Certified open source 
!  software that is licensed under any license containing this 
!  "Mutual Termination for Patent Action" clause infringes any 
!  patent claims that are essential to use that software.
!  
!  This license is Copyright (C) 2002 Lawrence E. Rosen. All 
!  rights reserved. Permission is hereby granted to copy and 
!  distribute this license without modification. This license may 
!  not be modified without at the express written permission of 
!  its copyright owner.
!  
!  C. Each Contributor must characterize its alteration of the 
!  Subject Software as a Modification and must identify itself as 
!  the originator of its Modification in a manner that reasonably 
...
!  must include a file (e.g., a change log file) that describes 
!  the alterations made and the date of the alterations, 
!  identifies Contributor as originator of the alterations, and 
!  consents to characterization of the alterations as a 
!  Modification, for example, by including a statement that the 
!  Modification is derived, directly or indirectly, from Original 
!  Software provided by Government Agency. Once consent is 
...
!  that may be construed as an endorsement by Government Agency or 
!  by any prior Recipient of any product or service provided by 
!  Recipient, or that may seek to obtain commercial advantage by 
!  the fact of Government Agency's or a prior Recipient's 
...
!  Subject Software, is requested to provide Government Agency, by 
!  e-mail to the Government Agency Point of Contact listed in 
!  clause 5.F., the following information: First and Last Name; 
!  Email Address; and Affiliation. Recipient's name and personal 
!  information shall be used for statistical purposes only. Once a 
!  Recipient makes a Modification available, it is requested that 
!  the Recipient inform Government Agency, by e-mail to the 
!  Government Agency Point of Contact listed in clause 5.F., how 
...
!  Recipient may do so, however, only on its own behalf and not on 
!  behalf of Government Agency or any other Recipient. Such a 
!  Recipient must make it absolutely clear that any such warranty, 
!  support, indemnity and/or liability obligation is offered by 
!  that Recipient alone. Further, such Recipient agrees to 
...
!  from the United States may require some form of export license 
!  from the U.S. Government. Failure to obtain necessary export 
!  licenses may result in criminal liability under U.S. laws. 
!  Government Agency neither represents that a license shall not 
!  be required nor that, if required, it shall be issued. Nothing 
!  granted herein provides any such export license. 
!  
...
!  PURPOSE, OR FREEDOM FROM INFRINGEMENT, ANY WARRANTY THAT THE 
!  SUBJECT SOFTWARE WILL BE ERROR FREE, OR ANY WARRANTY THAT 
!  DOCUMENTATION, IF PROVIDED, WILL CONFORM TO THE SUBJECT 
!  SOFTWARE. THIS AGREEMENT DOES NOT, IN ANY MANNER, CONSTITUTE AN 
!  ENDORSEMENT BY GOVERNMENT AGENCY OR ANY PRIOR RECIPIENT OF ANY 
!  RESULTS, RESULTING DESIGNS, HARDWARE, SOFTWARE PRODUCTS OR ANY 
...
!  LIABILITIES, DEMANDS, DAMAGES, EXPENSES OR LOSSES ARISING FROM 
!  SUCH USE, INCLUDING ANY DAMAGES FROM PRODUCTS BASED ON, OR 
!  RESULTING FROM, RECIPIENT'S USE OF THE SUBJECT SOFTWARE, 
!  RECIPIENT SHALL INDEMNIFY AND HOLD HARMLESS THE UNITED STATES 
!  GOVERNMENT, ITS CONTRACTORS AND SUBCONTRACTORS, AS WELL AS ANY 
!  PRIOR RECIPIENT, TO THE EXTENT PERMITTED BY LAW. RECIPIENT'S 
!  SOLE REMEDY FOR ANY SUCH MATTER SHALL BE THE IMMEDIATE, 
...
!  noncompliance within thirty (30) days of becoming aware of such 
!  noncompliance. Upon termination, a Recipient agrees to 
!  immediately cease use and distribution of the Subject Software. 
!  All sublicenses to the Subject Software properly granted by the 
!  breaching Recipient shall survive any such termination of this 
!  Agreement.
!  
...
!    MS 50, NASA Langley Research Center
!    Hampton, VA 23681
!    Fax: 757-864-4287
!    Phone: 757-864-2933
